    ...
    import ResetPasswordPage from "./pages/AuthPages/ForgotPassword/ResetPasswordPage";
    import EmailVerification from "./pages/AuthPages/Login/EmailVerification";
    ...
    function App() {
      ...
      const hideLayoutPaths = ["/login", "/signup", "/login-employee", "/forgot-password", "/reset-password", "/verify-email"];
