                ...
                <>
                    ...
                    >
                        <div className="flex flex-col items-start text-left absolute left-10 pt-28 gap-10 text-lg font-semibold text-yes">
                            <Link to="/" className="w-full" onClick={handleClick}>Home</Link>
                            <Link to="/products" className="w-full" onClick={handleClick}>Products</Link>
                            <Link to="/about" className="w-full" onClick={handleClick}>About Us</Link>
                            <Link to="/order-history" className="w-full" onClick={handleClick}>Order History</Link>
