// src/pages/admin/customer/CustomerDetailSidebar.js
        ...
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-gray-200">
              <h2 className="text-2xl font-bold text-red-600">Customer Detail</h2>
              <button
                onClick={onClose}
            ...
            <div className="flex-1 overflow-y-auto px-6 py-8 space-y-8">
              ...
              <div className="flex flex-col items-center text-center">
                <img
                  ...
                  className="w-28 h-28 rounded-full object-cover shadow-lg border-4 border-red-200"
                />
                <h3 className="mt-4 text-xl font-bold text-gray-900">{customer.username}</h3>
